...
<h3>array stuff</h3>
	...
	<?php
		...
		array_splice($lakesarraytype1,2,0,array("Lake Tahoe", "Iliamna Lake"));
		echo "Lake Tahoe and Iliamna Lake were added: ";
		print_r($lakesarraytype1);
		echo "<br>Lake Tahoe and Iliamna Lake were removed: ";
		array_splice($lakesarraytype1,2,2);
		print_r($lakesarraytype1);
		
		$motherrelative = array("Tessa", "Vincent", "Raymond", "Guerra", "Zara", "Woodard", "Guadalupe", "Huynh", "Tristin");
		$fatherrelative = array("Tessa", "Suarez", "Zara", "Woodard", "Barajas", "Guadalupe", "India");
		
		echo "<br>relative on mother's side: ";
		print_r($motherrelative);
		echo "<br>relative on father's side: ";
		print_r($fatherrelative);
		$merged = array_merge($motherrelative, $fatherrelative);
		echo "<br>relative of both sides combined: ";
		print_r($merged);
		sort($merged);
		echo "<br>relative of both sides combined and alphabetically organized: ";
		print_r($merged);
	?>
